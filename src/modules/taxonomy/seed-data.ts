...
export const standardTagSeeds = [
  ...
  { name: "Shift Kick", slug: "shift-kick", categorySlug: "kicking", sortOrder: 40 },
  { name: "Rear Kick", slug: "rear-kick", categorySlug: "kicking", sortOrder: 50 },
  ...
  { name: "Step Through", slug: "step-through", categorySlug: "footwork", sortOrder: 20 },
  { name: "Stance Switch", slug: "stance-switch", categorySlug: "footwork", sortOrder: 30 },
